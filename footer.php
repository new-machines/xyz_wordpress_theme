...
<footer class="blog-footer">
    ...
    <ul class="list-inline" style="margin-top:2rem">
        ...
        <li><a href="<?php echo get_option('facebook'); ?>"><i class="fa fa-facebook fa-2x" aria-hidden="true"></i></a></li>
        <li><a href="http://www.briancollins.xyz/feed/"><i class="fa fa-rss fa-2x" aria-hidden="true"></i></a></li>
    </ul>
</footer>
